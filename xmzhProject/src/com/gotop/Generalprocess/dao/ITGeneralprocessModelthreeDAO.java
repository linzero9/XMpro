...
public interface ITGeneralprocessModelthreeDAO {
	 ...
	 * @abatorgenerated
	 */
	void insert(TGeneralprocessModelthree record);

	/**
	 * 通过查询实例，查询记录
	 * @abatorgenerated
	 */
	List selectByExample(TGeneralprocessModelthreeExample example);

	/**
	 * 通过Bean方式的动态条件，查询分页数据
	 * @abatorgenerated
	 */
	List selectByExampleAndPage(TGeneralprocessModelthree record,
			TGeneralprocessModelthreeExample example, Page page);
	 ...
	 * @param example  条件
	 */
	TGeneralprocessModelthree expandEntityByTemplate(
			TGeneralprocessModelthree example);
	 ...
	 * @param example  条件
	 */
	List queryEntitiesByTemplate(TGeneralprocessModelthree example);
	 ...
	 * @param page  分页信息
	 */
	List queryEntitiesByTemplateWithPage(TGeneralprocessModelthree example,
			Page page);
	 ...
	 * @abatorgenerated
	 */
	int deleteByExample(TGeneralprocessModelthreeExample example);
	 ...
	 * @param example  条件
	 */
	int deleteByTemplate(TGeneralprocessModelthree example);

	/**
	 * 通过查询实例，统计总数
	 * @abatorgenerated
	 */
	int countByExample(TGeneralprocessModelthreeExample example);
	 ...
	 * @param example  条件
	 */
	int countByTemplate(TGeneralprocessModelthree example);

	/**
	 * 通过查询实例，更新非null字段
	 * @abatorgenerated
	 */
	int updateByExampleSelective(TGeneralprocessModelthree record,
			TGeneralprocessModelthreeExample example);

	/**
	 * 通过查询实例，更新全部字段
	 * @abatorgenerated
	 */
	int updateByExample(TGeneralprocessModelthree record,
			TGeneralprocessModelthreeExample example);
	 ...
	 * @param example  条件
	 */
	int updateEntityByTemplate(TGeneralprocessModelthree record,
			TGeneralprocessModelthree example);
}
			        		   ...
			        		   index=index+1;
					        	  ...
					        	  $.ajax({
								        ...
								        success: function (json) {
								        	...
								        	//showpanelhtml=showpanelhtml+'<tr><td class="form_label" align="right" style="width:120px;">'+item.name+ '</td><td>'+json.dicname+'</td></tr>';
						   					showpanelhtml=showpanelhtml+'<tr><td class="form_label" align="right" style="width:120px;">'+item.name+ '</td><td>'+json.dictname+'</td>';
						   					index=index+1;
									        }
							    });	
					        	  alert("dictname"+dictname);

...
<html>
		...
		<w:panel id="panel1" title="查询条件">
			<table align="center" border="0" width="100%" class="form_table">
				...
				<tr>
					...
					property="passRateReport.repTimeStart" /> 
					到
					<w:date format="yyyy-MM-dd" submitFormat="yyyyMMdd" id="repTimeEnd" name="passRateReport.repTimeEnd" 
					property="passRateReport.repTimeEnd" /></td>
					
                    <td class="form_label" align="right" >一级支行：</td>
					<td>
					    <h:text id="orgNameOne" property="passRateReport.orgNameOne" readonly="true"  style="width:130px;"/>
						<h:hidden id="orgCodeOne" property="passRateReport.orgCodeOne" />
					    <a href="#" onclick="open_slzhej_fun(1)">选择</a>
		            </td>	
		            
		            <td class="form_label" align="right" >二级支行：</td>
					<td>
					    <h:text id="orgNameTwo" property="passRateReport.orgNameTwo" readonly="true"  style="width:130px;"/>
						<h:hidden id="orgCodeTwo" property="passRateReport.orgCodeTwo" />
	...
	<DIV class="divList">
		           ...
		           <tr>
                           ...
                           <l:iterate property="errorStatisticList" id="id1">
							<tr class="<l:output evenOutput='EOS_table_row' oddOutput='EOS_table_row_o'  />">
								...
								<td nowrap="nowrap"> 
									<b:write iterateId="id1" property="reviewEmpname" />
								</td>
								<td nowrap="nowrap"> 
		...
		function clears(){
			...
			//清空传入后台的时间控件的值
			$name("passRateReport.repTimeStart").value = "";
			$name("passRateReport.repTimeEnd").value = "";

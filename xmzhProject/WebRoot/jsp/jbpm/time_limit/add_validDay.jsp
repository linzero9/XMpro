...
<h:form name="data_form"  id="data_form" action="/jbpm/timeLimitManageAction_saveValidDay.action"   method="post" >
		<table align="center" border="0" width="100%" class="form_table">
			<tr>
				<td > 
					有效日开始日期 <w:date id="startDate" property="time.startDate"  /><font style="color: red">*</font>
				</td>
				<td> 
					有效日结束日期 <w:date id="endDate" property="time.endDate"  /><font style="color: red">*</font>	
				</td>
			</tr>

...
<h:form name="data_form"  id="data_form" action="/jbpm/timeLimitManageAction_saveWorkTime.action"   method="post" >
		<h:hidden id="mianID"  property="timeBean.mianID" />
		<table align="center" border="0" width="100%" class="form_table">
			<tr>
				<td class="form_label" align="right"  width="40%">工作日有效期(回显)：</td>
			...
			<tr>
				...
				<td colspan="1" width="60%"> 
					开始时间 <w:time id="startTime1" property="timeBean.startTime1"  /><font style="color: red">*</font>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

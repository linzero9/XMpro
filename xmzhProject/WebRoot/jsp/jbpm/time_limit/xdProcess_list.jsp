...
<html>
	...
	<h:form name="query_form"	action="/jbpm/timeLimitManageAction_queryXdProcessList.action" method="post">
	...
	<DIV class="divList">
			<w:panel id="panel" width="100%" title="信贷流程发布列表">
				...
				<h:form name="page_form"
					action="/jbpm/timeLimitManageAction_queryXdProcessList.action" method="post">
              ...
              <td colspan="23" class="command_sort_area">
							...
							<l:greaterThan property="page.count" targetValue="0" compareType="number" >
								&nbsp; &nbsp;
								<input type="button" class="button" value="时限管理配置"
									onclick="timeLimitManage();" />
									</l:greaterThan>
							</div>
							<div class="h4">

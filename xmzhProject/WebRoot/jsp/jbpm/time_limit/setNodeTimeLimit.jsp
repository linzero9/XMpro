...
<h:form name="data_form"  id="data_form"  action="/jbpm/timeLimitManageAction_saveNodeTimeLimit.action" method="post" onsubmit="return checkForm(this);">
		...
		<h:text id="e_id" property="nodeTimeLimitBean.e_id" /> 
		<h:text id="c_id" property="nodeTimeLimitBean.c_id" />
			<tr>
			...
			<tr>
				...
				<td colspan="1">
				<h:text id="timeLimit" property="nodeTimeLimitBean.timeLimit"   validateAttr="allowNull=false;" /> 工时
			</tr>

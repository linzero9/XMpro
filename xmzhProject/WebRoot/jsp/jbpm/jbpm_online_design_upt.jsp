							...
							tools : {
								save : {
									onclick : function(data) {
								 	 	 ...
								 	 	 $.ajax({
										      url: "/jbpm/jbpmDemoAction_makeAndUpdateJbpm.action",
										      async: false,
										      type: 'post',
										      data: "data="+data + "&pname=" +'${pname}' + "&deploymentId=" + '${deploymentId}' + "&definitionId=" + '${definitionId}',
										      timeout: 60000,
										      dataType:"text",
										      success: function (data) {
										    	  if (data.indexOf("success") >= 0) {
										    			var hh=data.split(",");
														var strUrl = "/jbpm/jbpmDemoAction_toProcessTaskConfig.action?taskAssgineeDto.definitionId="+hh[1] + "&taskAssgineeDto.isUpdate=isUpdate";
...
<div id="myflow" style="position: absolute; top: 10; left: 100; "></div>
</body>

...
<h:form name="data_form"  id="data_form" action="/jbpm/jbpmDemoAction_uptateProcess.action"  enctype="multipart/form-data" method="post" >
<table align="center" border="0" width="100%" class="form_table">
<input type="hidden" id="pid" name="processDeployDto.id" value="<b:write property="processDeployDto.id"/>">
			<input type="hidden" id="processDefinitionId" name="processDeployDto.processDefinitionId" value="<b:write property="processDeployDto.processDefinitionId"/>">
			...
			<tr>
					...
					<td colspan="1"  width="30%"><h:text validateAttr="allowNull=false;maxLength=15"  id="orderNo" property="processDeployDto.orderNo" /></td>
			</tr>
		<%-- 	<tr>
				<td class="form_label" align="right" width="15%">工作事项类型：</td>
				<td colspan="1" width="30%">
				<h:select id="businessType" name="processDeployDto.businessType"  property="processDeployDto.businessType" validateAttr="allowNull=false;" >
			...
			<tr>
					...
					<td colspan="1"  width="30%">
					<h:select style="width:148px;" id="deployType" name="processDeployDto.deployType" validateAttr="allowNull=false;"  property="processDeployDto.deployType">
			...
			<tr>
					...
					<td colspan="1"  width="30%">
					<h:select style="width:148px;" id="processState" name="processDeployDto.processState"  property="processDeployDto.processState" validateAttr="allowNull=false;" >
      	...
      	<tr>
			...
			<td colspan="4"><input type="button" value="保存" " class="button"  onclick="saveAndPub();"> <input type="button"

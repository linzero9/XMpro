...
<h:form name="data_form"  id="data_form"  action="/jbpm/jbpmDemoAction_updateTaskConfig.action" method="post" onsubmit="return checkForm(this);">
		...
		<h:hidden id="oldTaskName" property="taskAssgineeDto.taskName" />
			<tr>
	...
	function openNewEmpTreeCallBack(arg) {
		...
		if (arg['Organization']) {
			...
			for ( var i = 0; i < sorgidArra.length; i++) {
				argRes[0].push(sorgidArra[i].getProperty("objCode"));

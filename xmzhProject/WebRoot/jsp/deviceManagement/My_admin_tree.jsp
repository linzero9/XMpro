...
//		lookupInit();
	...
	function orgTree2InitParam(){
		...
		var positioncode = '${changeTree.positioncode}';
		
		var param = "<orgType>"+orgType+"</orgType>" + "<p1>"+positioncode+"</p1>";

		var orgflag = $id("orgflag").value;
		param +="<orgflag>"+orgflag+"</orgflag>";
		return param;
	}
		...
		<table align="left" border="0" height="100%" width="100%" style="vertical-align: top;">
			<tr valign="top">
				<td width="100%" valign="top">
					...
					<h:hidden id="orgflag"  property="orgflag"/>
					<r:rtree id="orgSrcTree"  width="100%" height="370">
						...
						<r:treeNode nodeType="Organization" showField="orgname"
							...
							action="/deviceManagement/myMainTreeAction_selectAdminTreeChild.action">
							<r:treeMenu>

  ...
  <head>                                                                     
    ...
    <script type="text/javascript">
		function downExl1(){
			...
			var strUrl = "/opinion/tApproveOpninionAction_downExl1.action?"+"resourceType="+resourceType+"&resourceFlow="+resourceFlow;
		...
		<tr>
		 ...
		 <tr>
		        <td colspan="9" class="command_sort_area">
		        	<div class="h3">
		          		<input id="detailBu" type="button" class="button" value="导出意见" onclick="downExl1();">
	              </div>
	              <div class="h4">
